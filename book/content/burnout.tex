...
\renewcommand*{\footnoterule}{%
  ...
  \kern2.6pt}
\renewfontfamily\pagenumfont{Gentium Book Basic}[Color=444444FF]
\begin{paracol}{2}
  \begin{leftcolumn}
    \fontspec{Gentium Book Basic}[Color=444444FF,Ligatures=TeX]
    \renewfontfamily\allyFont{Merriweather Sans}[Scale=0.9,Color=666666FF,Ligatures=TeX]
